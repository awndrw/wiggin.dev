  ...
  return (
    <animated.path
      ...
      style={{
        ...
        strokeDashoffset: pathStyle.scrollYProgress.to((scrollProgress) => {
          const progress = scrollProgress / 2.5 + 0.58;
          return minmax(pathLength - progress * pathLength, 0, pathLength);
        }),
        strokeDasharray: pathStyle.pathLength,
      }}
