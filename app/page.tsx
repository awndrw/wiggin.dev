  ...
  return (
    <div className={styles.page}>
      <section role="main" className={styles.hero}>
        ...
        />
        <ScribblePath
          viewBox="0 0 484.92 572"
          className={c(styles.scribble, styles.two)}
          animatedSegmentLength={5}
          d="m8.21,73.76C58.76,28.23,125.61.5,198.92.5c157.68,0,285.5,127.82,285.5,285.5s-127.82,285.5-285.5,285.5c-77.17,0-147.19-30.62-198.57-80.36"
        />
      </section>
