...
export default function Page() {
  ...
  return (
    <main ref={mainRef} className={styles.main}>
      {/* PLANTS */}
      <animated.div
        style={{ transform: zoomStyle.plants }}
      ...
      {/* TEXT */}
      <animated.div
        style={{ transform: zoomStyle.text }}
      ...
      >
        ...
        <animated.button style={continueButtonStyle} onClick={onContinueClick}>
          <svg
...
type AvailableSvgProps = Omit<
  React.ComponentProps<typeof animated.svg>,
