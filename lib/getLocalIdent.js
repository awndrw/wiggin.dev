function classNameGenerator() {
  ...
  return function getNextClassName() {
...
module.exports = function localIdentGenerator() {
  const classes = {};
  const getNextClassName = classNameGenerator();
   ...
   */
  return function getLocalIdent(context, _, localName) {
